...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "PT Tiga Warna Primer — Menciptakan Warna, Mendefinisikan Kualitas" },
      { name: "description", content: "Produsen pewarna tekstil & bahan kimia berkualitas tinggi di Tangerang, Indonesia. Inovasi, keberlanjutan, dan jaminan kualitas COA." },
      { name: "author", content: "PT Tiga Warna Primer" },
